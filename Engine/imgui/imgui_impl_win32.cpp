...
#endif
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam, float imguiMouseScaleW, float imguiMouseScaleH)
{
    ...
    case WM_MOUSEMOVE:
        ...
        io.AddMousePosEvent((float)GET_X_LPARAM(lParam) * imguiMouseScaleW, (float)GET_Y_LPARAM(lParam) * imguiMouseScaleH);
        break;
    case WM_MOUSELEAVE:
